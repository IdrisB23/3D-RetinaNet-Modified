...
from mmpretrain_custom.models.utils.norm import GRN3d
from mmpretrain.models.backbones.base_backbone import BaseBackbone



class ConvNeXtI3DBlock(BaseModule):
    """ConvNeXt Block.
    ...
    Note:
        ...
        1. DwConv -> LayerNorm -> 1x1 Conv -> GELU -> 1x1 Conv;
           all outputs are in (N, C, T, H, W).
        2. DwConv -> LayerNorm -> Permute to (N, T, H, W, C) -> Linear -> GELU
           -> Linear; Permute back
    ...
    def __init__(self,
                 in_channels,
                 dw_conv_cfg=dict(kernel_size=(1, 7, 7), padding=(0, 3, 3)),
...
class ConvNeXtI3D(BaseBackbone):
    """This is an inflated version of ConvNeXt v1&v2 backbone, whereas only the spatial dimensions are handled.
        ...
        for i, stage in enumerate(self.stages):
            ...
            if i in self.out_indices:
                ...
                if self.gap_before_final_norm:
                    ...
                    outs.append(norm_layer(gap).flatten(2))
                else:
    ...
    def train(self, mode=True):
        super(ConvNeXtI3D, self).train(mode)
        self._freeze_stages()
